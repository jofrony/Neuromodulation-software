...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "cvodeieq");
 	...
 	ivoc_help("help ?1 im_lts_ptr /home/jofrony/Documents/Repositories/Neuromodulation-software/examples/x86_64/im_lts_ptr.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/jofrony/Documents/Repositories/Neuromodulation-software/examples/mechanisms-modulation-ptr/im_lts_ptr.mod";
static const char* nmodl_file_text = 
