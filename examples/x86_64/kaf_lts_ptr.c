...
#define nrn_init _nrn_init__kaf_lts_ptr
#define _nrn_initial _nrn_initial__kaf_lts_ptr
#define nrn_cur _nrn_cur__kaf_lts_ptr
#define _nrn_current _nrn_current__kaf_lts_ptr
#define nrn_jacob _nrn_jacob__kaf_lts_ptr
#define nrn_state _nrn_state__kaf_lts_ptr
#define _net_receive _net_receive__kaf_lts_ptr 
#define rates rates__kaf_lts_ptr 
#define states states__kaf_lts_ptr 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_kaf_lts_ptr", _hoc_setdata,
 "modulationDA_kaf_lts_ptr", _hoc_modulationDA,
 "rates_kaf_lts_ptr", _hoc_rates,
 0, 0
};
#define modulationDA modulationDA_kaf_lts_ptr
 ...
 "gbar_kaf_lts_ptr", "S/cm2",
 "ik_kaf_lts_ptr", "mA/cm2",
 "gk_kaf_lts_ptr", "S/cm2",
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 kaf_lts_ptr /home/jofrony/Documents/Repositories/BasalGangliaExperiments/Neuromodulation-software/examples/x86_64/kaf_lts_ptr.mod\n");
 ...
 v=_v;
{
  ek = _ion_ek;
 { error =  states();
 if(error){fprintf(stderr,"at line 68 in file kaf_lts_ptr.mod:\n    SOLVE states METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/jofrony/Documents/Repositories/BasalGangliaExperiments/Neuromodulation-software/examples/mechanisms-modulation-ptr/kaf_lts_ptr.mod";
static const char* nmodl_file_text = 
