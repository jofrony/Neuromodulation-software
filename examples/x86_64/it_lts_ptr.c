...
#define nrn_init _nrn_init__it_lts_ptr
#define _nrn_initial _nrn_initial__it_lts_ptr
#define nrn_cur _nrn_cur__it_lts_ptr
#define _nrn_current _nrn_current__it_lts_ptr
#define nrn_jacob _nrn_jacob__it_lts_ptr
#define nrn_state _nrn_state__it_lts_ptr
#define _net_receive _net_receive__it_lts_ptr 
#define castate castate__it_lts_ptr 
#define evaluate_fct evaluate_fct__it_lts_ptr 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_it_lts_ptr", _hoc_setdata,
 "evaluate_fct_it_lts_ptr", _hoc_evaluate_fct,
 "modulationDA_it_lts_ptr", _hoc_modulationDA,
 0, 0
};
#define modulationDA modulationDA_it_lts_ptr
 extern double modulationDA( );
 /* declare global and static user variables */
#define q10 q10_it_lts_ptr
 double q10 = 3;
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "cvodeieq");
 	...
 	ivoc_help("help ?1 it_lts_ptr /home/jofrony/Documents/Repositories/BasalGangliaExperiments/Neuromodulation-software/examples/x86_64/it_lts_ptr.mod\n");
 ...
 v=_v;
{
  ...
  cao = _ion_cao;
 { error =  castate();
 if(error){fprintf(stderr,"at line 101 in file it_lts_ptr.mod:\n	SOLVE castate METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/jofrony/Documents/Repositories/BasalGangliaExperiments/Neuromodulation-software/examples/mechanisms-modulation-ptr/it_lts_ptr.mod";
static const char* nmodl_file_text = 
