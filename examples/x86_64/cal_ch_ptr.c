...
#define nrn_init _nrn_init__cal_ch_ptr
#define _nrn_initial _nrn_initial__cal_ch_ptr
#define nrn_cur _nrn_cur__cal_ch_ptr
#define _nrn_current _nrn_current__cal_ch_ptr
#define nrn_jacob _nrn_jacob__cal_ch_ptr
#define nrn_state _nrn_state__cal_ch_ptr
#define _net_receive _net_receive__cal_ch_ptr 
#define rate rate__cal_ch_ptr 
#define state state__cal_ch_ptr 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_cal_ch_ptr", _hoc_setdata,
 "KTF_cal_ch_ptr", _hoc_KTF,
 "alp_cal_ch_ptr", _hoc_alp,
 "bet_cal_ch_ptr", _hoc_bet,
 "efun_cal_ch_ptr", _hoc_efun,
 "ghk_cal_ch_ptr", _hoc_ghk,
 "h2_cal_ch_ptr", _hoc_h2,
 "modulationACh_cal_ch_ptr", _hoc_modulationACh,
 "rate_cal_ch_ptr", _hoc_rate,
 0, 0
};
#define KTF KTF_cal_ch_ptr
#define _f_bet _f_bet_cal_ch_ptr
#define _f_alp _f_alp_cal_ch_ptr
#define alp alp_cal_ch_ptr
#define bet bet_cal_ch_ptr
#define efun efun_cal_ch_ptr
#define ghk ghk_cal_ch_ptr
#define h2 h2_cal_ch_ptr
#define modulationACh modulationACh_cal_ch_ptr
...
#define Ctm Ctm_cal_ch_ptr
 double Ctm = 3;
#define atm atm_cal_ch_ptr
 double atm = 12;
#define btm btm_cal_ch_ptr
 double btm = 11;
#define ki ki_cal_ch_ptr
 double ki = 0.001;
#define minf minf_cal_ch_ptr
 double minf = 0;
#define tfa tfa_cal_ch_ptr
 double tfa = 1;
#define tau tau_cal_ch_ptr
 double tau = 0;
#define tm0 tm0_cal_ch_ptr
 double tm0 = 0;
#define usetable usetable_cal_ch_ptr
 double usetable = 1;
#define vhtm vhtm_cal_ch_ptr
 double vhtm = -2;
#define vcm vcm_cal_ch_ptr
 double vcm = 5.6;
#define vhm vhm_cal_ch_ptr
 double vhm = -1.5;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "usetable_cal_ch_ptr", 0, 1,
 0,0,0
};
 static HocParmUnits _hoc_parm_units[] = {
 "ki_cal_ch_ptr", "mM",
 "tau_cal_ch_ptr", "ms",
 "gbar_cal_ch_ptr", "mho/cm2",
 "ica_cal_ch_ptr", "mA/cm2",
 "gcal_cal_ch_ptr", "mho/cm2",
 0,0
};
 ...
 "ki_cal_ch_ptr", &ki_cal_ch_ptr,
 "tfa_cal_ch_ptr", &tfa_cal_ch_ptr,
 "vhm_cal_ch_ptr", &vhm_cal_ch_ptr,
 "vcm_cal_ch_ptr", &vcm_cal_ch_ptr,
 "Ctm_cal_ch_ptr", &Ctm_cal_ch_ptr,
 "atm_cal_ch_ptr", &atm_cal_ch_ptr,
 "btm_cal_ch_ptr", &btm_cal_ch_ptr,
 "tm0_cal_ch_ptr", &tm0_cal_ch_ptr,
 "vhtm_cal_ch_ptr", &vhtm_cal_ch_ptr,
 "minf_cal_ch_ptr", &minf_cal_ch_ptr,
 "tau_cal_ch_ptr", &tau_cal_ch_ptr,
 "usetable_cal_ch_ptr", &usetable_cal_ch_ptr,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "cvodeieq");
 	...
 	ivoc_help("help ?1 cal_ch_ptr /home/jofrony/Documents/Repositories/BasalGangliaExperiments/Neuromodulation-software/examples/x86_64/cal_ch_ptr.mod\n");
 ...
 v=_v;
{
  ...
  cao = _ion_cao;
 { error =  state();
 if(error){fprintf(stderr,"at line 59 in file cal_ch_ptr.mod:\n	SOLVE state METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/jofrony/Documents/Repositories/BasalGangliaExperiments/Neuromodulation-software/examples/mechanisms-modulation-ptr/cal_ch_ptr.mod";
static const char* nmodl_file_text = 
