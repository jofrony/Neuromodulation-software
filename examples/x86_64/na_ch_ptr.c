...
#define nrn_init _nrn_init__na_ch_ptr
#define _nrn_initial _nrn_initial__na_ch_ptr
#define nrn_cur _nrn_cur__na_ch_ptr
#define _nrn_current _nrn_current__na_ch_ptr
#define nrn_jacob _nrn_jacob__na_ch_ptr
#define nrn_state _nrn_state__na_ch_ptr
#define _net_receive _net_receive__na_ch_ptr 
#define kin kin__na_ch_ptr 
#define rates rates__na_ch_ptr 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_na_ch_ptr", _hoc_setdata,
 "modulationDA_na_ch_ptr", _hoc_modulationDA,
 "rates_na_ch_ptr", _hoc_rates,
 0, 0
};
#define modulationDA modulationDA_na_ch_ptr
 extern double modulationDA( );
 /* declare global and static user variables */
#define Coff Coff_na_ch_ptr
 double Coff = 0.1;
#define Con Con_na_ch_ptr
 double Con = 0.001;
#define Ooff Ooff_na_ch_ptr
 double Ooff = 0.01;
#define Oon Oon_na_ch_ptr
 double Oon = 0.7;
#define aS2 aS2_na_ch_ptr
 double aS2 = 0.0002;
#define aS1 aS1_na_ch_ptr
 double aS1 = 0.0025;
#define a0 a0_na_ch_ptr
 double a0 = 37;
#define bS bS_na_ch_ptr
 double bS = 0.00017;
#define b0 b0_na_ch_ptr
 double b0 = 10;
#define d0 d0_na_ch_ptr
 double d0 = 30;
#define g0 g0_na_ch_ptr
 double g0 = 40;
#define vcb vcb_na_ch_ptr
 double vcb = -20;
#define vhb vhb_na_ch_ptr
 double vhb = -50;
#define vca vca_na_ch_ptr
 double vca = 40;
#define vha vha_na_ch_ptr
 double vha = 45;
 ...
 "Oon_na_ch_ptr", "1/ms",
 "Ooff_na_ch_ptr", "1/ms",
 "gbar_na_ch_ptr", "S/cm2",
 "g_na_ch_ptr", "S/cm2",
 "ina_na_ch_ptr", "mA/cm2",
 0,0
};
 static double ct0 = 0;
 static double c50 = 0;
 ...
 "a0_na_ch_ptr", &a0_na_ch_ptr,
 "vha_na_ch_ptr", &vha_na_ch_ptr,
 "vca_na_ch_ptr", &vca_na_ch_ptr,
 "b0_na_ch_ptr", &b0_na_ch_ptr,
 "vhb_na_ch_ptr", &vhb_na_ch_ptr,
 "vcb_na_ch_ptr", &vcb_na_ch_ptr,
 "g0_na_ch_ptr", &g0_na_ch_ptr,
 "d0_na_ch_ptr", &d0_na_ch_ptr,
 "aS1_na_ch_ptr", &aS1_na_ch_ptr,
 "aS2_na_ch_ptr", &aS2_na_ch_ptr,
 "bS_na_ch_ptr", &bS_na_ch_ptr,
 "Con_na_ch_ptr", &Con_na_ch_ptr,
 "Coff_na_ch_ptr", &Coff_na_ch_ptr,
 "Oon_na_ch_ptr", &Oon_na_ch_ptr,
 "Ooff_na_ch_ptr", &Ooff_na_ch_ptr,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 na_ch_ptr /home/jofrony/Documents/Repositories/BasalGangliaExperiments/Neuromodulation-software/examples/x86_64/na_ch_ptr.mod\n");
 ...
 t = 0.0;
{
 ...
 if(error){fprintf(stderr,"at line 134 in file na_ch_ptr.mod:\n	SOLVE kin STEADYSTATE sparse\n"); nrn_complain(_p); abort_run(error);}
    if (secondorder) {
    int _i;
    for (_i = 0; _i < 14; ++_i) {
 ...
 v=_v;
{
 ...
 if(error){fprintf(stderr,"at line 124 in file na_ch_ptr.mod:\n	SOLVE kin METHOD sparse\n"); nrn_complain(_p); abort_run(error);}
    if (secondorder) {
    int _i;
    for (_i = 0; _i < 14; ++_i) {
      _p[_slist1[_i]] += dt*_p[_dlist1[_i]];
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/jofrony/Documents/Repositories/BasalGangliaExperiments/Neuromodulation-software/examples/mechanisms-modulation-ptr/na_ch_ptr.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
  "NA_CH.MOD\n"
  "\n"
