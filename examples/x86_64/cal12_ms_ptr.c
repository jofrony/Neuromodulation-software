...
#define nrn_init _nrn_init__cal12_ms_ptr
#define _nrn_initial _nrn_initial__cal12_ms_ptr
#define nrn_cur _nrn_cur__cal12_ms_ptr
#define _nrn_current _nrn_current__cal12_ms_ptr
#define nrn_jacob _nrn_jacob__cal12_ms_ptr
#define nrn_state _nrn_state__cal12_ms_ptr
#define _net_receive _net_receive__cal12_ms_ptr 
#define rates rates__cal12_ms_ptr 
#define states states__cal12_ms_ptr 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_cal12_ms_ptr", _hoc_setdata,
 "efun_cal12_ms_ptr", _hoc_efun,
 "ghk_cal12_ms_ptr", _hoc_ghk,
 "modulationACh_cal12_ms_ptr", _hoc_modulationACh,
 "modulationDA_cal12_ms_ptr", _hoc_modulationDA,
 "rates_cal12_ms_ptr", _hoc_rates,
 0, 0
};
#define efun efun_cal12_ms_ptr
#define ghk ghk_cal12_ms_ptr
#define modulationACh modulationACh_cal12_ms_ptr
#define modulationDA modulationDA_cal12_ms_ptr
...
#define a a_cal12_ms_ptr
 double a = 0.17;
#define q q_cal12_ms_ptr
 double q = 2;
 ...
 "pbar_cal12_ms_ptr", "cm/s",
 "ical_cal12_ms_ptr", "mA/cm2",
 0,0
};
 ...
 "a_cal12_ms_ptr", &a_cal12_ms_ptr,
 "q_cal12_ms_ptr", &q_cal12_ms_ptr,
 0,0
};
...
"cal12_ms_ptr",
 "pbar_cal12_ms_ptr",
 "modDA_cal12_ms_ptr",
 "maxModDA_cal12_ms_ptr",
 "modACh_cal12_ms_ptr",
 "maxModACh_cal12_ms_ptr",
 0,
 "ical_cal12_ms_ptr",
 0,
 "m_cal12_ms_ptr",
 "h_cal12_ms_ptr",
 0,
 "levelDA_cal12_ms_ptr",
 "levelACh_cal12_ms_ptr",
 0};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 6, "cvodeieq");
 	...
 	ivoc_help("help ?1 cal12_ms_ptr /home/jofrony/Documents/Repositories/BasalGangliaExperiments/Neuromodulation-software/examples/x86_64/cal12_ms_ptr.mod\n");
 ...
 v=_v;
{
  ...
  calo = _ion_calo;
 { error =  states();
 if(error){fprintf(stderr,"at line 81 in file cal12_ms_ptr.mod:\n    SOLVE states METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/jofrony/Documents/Repositories/BasalGangliaExperiments/Neuromodulation-software/examples/mechanisms-modulation-ptr/cal12_ms_ptr.mod";
static const char* nmodl_file_text = 
