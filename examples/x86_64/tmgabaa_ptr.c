...
#define nrn_init _nrn_init__tmGabaA_ptr
#define _nrn_initial _nrn_initial__tmGabaA_ptr
#define nrn_cur _nrn_cur__tmGabaA_ptr
#define _nrn_current _nrn_current__tmGabaA_ptr
#define nrn_jacob _nrn_jacob__tmGabaA_ptr
#define nrn_state _nrn_state__tmGabaA_ptr
#define _net_receive _net_receive__tmGabaA_ptr 
#define state state__tmGabaA_ptr 
...
#define modACh _p[10]
#define maxModACh _p[11]
#define failRateA _p[12]
#define failRateB _p[13]
...
#define levelDA	*_ppvar[2]._pval
#define _p_levelDA	_ppvar[2]._pval
...
#define modulationACh modulationACh_tmGabaA_ptr
#define modulationDA modulationDA_tmGabaA_ptr
#define urand urand_tmGabaA_ptr
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 5;
 	...
 	ivoc_help("help ?1 tmGabaA_ptr /home/jofrony/Documents/Repositories/BasalGangliaExperiments/Neuromodulation-software/examples/x86_64/tmgabaa_ptr.mod\n");
...
{
 { error =  state();
 if(error){fprintf(stderr,"at line 92 in file tmgabaa_ptr.mod:\n    SOLVE state METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 }}}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/jofrony/Documents/Repositories/BasalGangliaExperiments/Neuromodulation-software/examples/mechanisms-modulation-ptr/tmgabaa_ptr.mod";
static const char* nmodl_file_text = 
