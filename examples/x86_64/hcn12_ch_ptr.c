...
#define nrn_init _nrn_init__hcn12_ch_ptr
#define _nrn_initial _nrn_initial__hcn12_ch_ptr
#define nrn_cur _nrn_cur__hcn12_ch_ptr
#define _nrn_current _nrn_current__hcn12_ch_ptr
#define nrn_jacob _nrn_jacob__hcn12_ch_ptr
#define nrn_state _nrn_state__hcn12_ch_ptr
#define _net_receive _net_receive__hcn12_ch_ptr 
#define kin kin__hcn12_ch_ptr 
#define rates rates__hcn12_ch_ptr 
...
#define Dcao _p[17]
#define _g _p[18]
#define levelDA	*_ppvar[0]._pval
#define _p_levelDA	_ppvar[0]._pval
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_hcn12_ch_ptr", _hoc_setdata,
 "modulationDA_hcn12_ch_ptr", _hoc_modulationDA,
 "rates_hcn12_ch_ptr", _hoc_rates,
 0, 0
};
#define modulationDA modulationDA_hcn12_ch_ptr
 extern double modulationDA( );
 /* declare global and static user variables */
#define ai ai_hcn12_ch_ptr
 double ai = 1e-05;
#define aac aac_hcn12_ch_ptr
 double aac = -0.075;
#define aah aah_hcn12_ch_ptr
 double aah = -94.2;
#define aa0 aa0_hcn12_ch_ptr
 double aa0 = 0.0006;
#define ac ac_hcn12_ch_ptr
 double ac = -0.155;
#define ah ah_hcn12_ch_ptr
 double ah = -96;
#define a0 a0_hcn12_ch_ptr
 double a0 = 0.006;
#define bf bf_hcn12_ch_ptr
 double bf = 8.94;
#define b b_hcn12_ch_ptr
 double b = 80;
#define bac bac_hcn12_ch_ptr
 double bac = 0.144;
#define bah bah_hcn12_ch_ptr
 double bah = -35.5;
#define ba0 ba0_hcn12_ch_ptr
 double ba0 = 0.004;
#define bc bc_hcn12_ch_ptr
 double bc = 0.144;
#define bh bh_hcn12_ch_ptr
 double bh = -51.7;
#define b0 b0_hcn12_ch_ptr
 double b0 = 0.0008;
#define gca gca_hcn12_ch_ptr
 double gca = 1;
#define koff koff_hcn12_ch_ptr
 double koff = 4.5e-05;
#define kon kon_hcn12_ch_ptr
 double kon = 30;
#define q10a q10a_hcn12_ch_ptr
 double q10a = 1.5;
#define q10v q10v_hcn12_ch_ptr
 double q10v = 4;
#define shift shift_hcn12_ch_ptr
 double shift = -17;
 ...
 "aac_hcn12_ch_ptr", "/mV",
 "bac_hcn12_ch_ptr", "/mV",
 "kon_hcn12_ch_ptr", "/mM-ms",
 "koff_hcn12_ch_ptr", "/ms",
 "ai_hcn12_ch_ptr", "mM",
 "shift_hcn12_ch_ptr", "mV",
 "gbar_hcn12_ch_ptr", "S/cm2",
 "ehcn_hcn12_ch_ptr", "mV",
 "g_hcn12_ch_ptr", "S/cm2",
 "i_hcn12_ch_ptr", "mA/cm2",
 0,0
};
 ...
 "a0_hcn12_ch_ptr", &a0_hcn12_ch_ptr,
 "b0_hcn12_ch_ptr", &b0_hcn12_ch_ptr,
 "ah_hcn12_ch_ptr", &ah_hcn12_ch_ptr,
 "bh_hcn12_ch_ptr", &bh_hcn12_ch_ptr,
 "ac_hcn12_ch_ptr", &ac_hcn12_ch_ptr,
 "bc_hcn12_ch_ptr", &bc_hcn12_ch_ptr,
 "aa0_hcn12_ch_ptr", &aa0_hcn12_ch_ptr,
 "ba0_hcn12_ch_ptr", &ba0_hcn12_ch_ptr,
 "aah_hcn12_ch_ptr", &aah_hcn12_ch_ptr,
 "bah_hcn12_ch_ptr", &bah_hcn12_ch_ptr,
 "aac_hcn12_ch_ptr", &aac_hcn12_ch_ptr,
 "bac_hcn12_ch_ptr", &bac_hcn12_ch_ptr,
 "kon_hcn12_ch_ptr", &kon_hcn12_ch_ptr,
 "koff_hcn12_ch_ptr", &koff_hcn12_ch_ptr,
 "b_hcn12_ch_ptr", &b_hcn12_ch_ptr,
 "bf_hcn12_ch_ptr", &bf_hcn12_ch_ptr,
 "ai_hcn12_ch_ptr", &ai_hcn12_ch_ptr,
 "gca_hcn12_ch_ptr", &gca_hcn12_ch_ptr,
 "shift_hcn12_ch_ptr", &shift_hcn12_ch_ptr,
 "q10v_hcn12_ch_ptr", &q10v_hcn12_ch_ptr,
 "q10a_hcn12_ch_ptr", &q10a_hcn12_ch_ptr,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 1, "cvodeieq");
 	...
 	ivoc_help("help ?1 hcn12_ch_ptr /home/jofrony/Documents/Repositories/BasalGangliaExperiments/Neuromodulation-software/examples/x86_64/hcn12_ch_ptr.mod\n");
 ...
 t = 0.0;
{
  ...
  o = o0;
 {
   error = _ss_sparse(&_sparseobj1, 4, _slist1, _dlist1, _p, &t, dt, kin,&_coef1, _linmat1);
 if(error){fprintf(stderr,"at line 98 in file hcn12_ch_ptr.mod:\n	SOLVE kin STEADYSTATE sparse\n"); nrn_complain(_p); abort_run(error);}
    if (secondorder) {
    int _i;
    for (_i = 0; _i < 4; ++_i) {
...
for (_iml = 0; _iml < _cntml; ++_iml) {
 ...
 v=_v;
{
 { error = sparse(&_sparseobj1, 4, _slist1, _dlist1, _p, &t, dt, kin,&_coef1, _linmat1);
 if(error){fprintf(stderr,"at line 102 in file hcn12_ch_ptr.mod:\n	SOLVE kin METHOD sparse\n"); nrn_complain(_p); abort_run(error);}
    if (secondorder) {
    int _i;
    for (_i = 0; _i < 4; ++_i) {
      _p[_slist1[_i]] += dt*_p[_dlist1[_i]];
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/jofrony/Documents/Repositories/BasalGangliaExperiments/Neuromodulation-software/examples/mechanisms-modulation-ptr/hcn12_ch_ptr.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
  "\n"
