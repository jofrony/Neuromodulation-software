...
#define nrn_init _nrn_init__kir23_ch_ptr
#define _nrn_initial _nrn_initial__kir23_ch_ptr
#define nrn_cur _nrn_cur__kir23_ch_ptr
#define _nrn_current _nrn_current__kir23_ch_ptr
#define nrn_jacob _nrn_jacob__kir23_ch_ptr
#define nrn_state _nrn_state__kir23_ch_ptr
#define _net_receive _net_receive__kir23_ch_ptr 
#define rates rates__kir23_ch_ptr 
#define states states__kir23_ch_ptr 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_kir23_ch_ptr", _hoc_setdata,
 "modulationACh_kir23_ch_ptr", _hoc_modulationACh,
 "rates_kir23_ch_ptr", _hoc_rates,
 0, 0
};
#define modulationACh modulationACh_kir23_ch_ptr
 extern double modulationACh( );
 /* declare global and static user variables */
#define q q_kir23_ch_ptr
 double q = 1;
 ...
 "gbar_kir23_ch_ptr", "S/cm2",
 "ik_kir23_ch_ptr", "mA/cm2",
 "gk_kir23_ch_ptr", "S/cm2",
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 kir23_ch_ptr /home/jofrony/Documents/Repositories/BasalGangliaExperiments/Neuromodulation-software/examples/x86_64/kir23_ch_ptr.mod\n");
 ...
 v=_v;
{
  ek = _ion_ek;
 { error =  states();
 if(error){fprintf(stderr,"at line 66 in file kir23_ch_ptr.mod:\n    SOLVE states METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/jofrony/Documents/Repositories/BasalGangliaExperiments/Neuromodulation-software/examples/mechanisms-modulation-ptr/kir23_ch_ptr.mod";
static const char* nmodl_file_text = 
