...
#define nrn_init _nrn_init__kir_ms_ptr
#define _nrn_initial _nrn_initial__kir_ms_ptr
#define nrn_cur _nrn_cur__kir_ms_ptr
#define _nrn_current _nrn_current__kir_ms_ptr
#define nrn_jacob _nrn_jacob__kir_ms_ptr
#define nrn_state _nrn_state__kir_ms_ptr
#define _net_receive _net_receive__kir_ms_ptr 
#define rates rates__kir_ms_ptr 
#define states states__kir_ms_ptr 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_kir_ms_ptr", _hoc_setdata,
 "modulationACh_kir_ms_ptr", _hoc_modulationACh,
 "modulationDA_kir_ms_ptr", _hoc_modulationDA,
 "rates_kir_ms_ptr", _hoc_rates,
 0, 0
};
#define modulationACh modulationACh_kir_ms_ptr
#define modulationDA modulationDA_kir_ms_ptr
 extern double modulationACh( );
 extern double modulationDA( );
 /* declare global and static user variables */
#define q q_kir_ms_ptr
 double q = 1;
 ...
 "gbar_kir_ms_ptr", "S/cm2",
 "shift_kir_ms_ptr", "mV",
 "ik_kir_ms_ptr", "mA/cm2",
 "gk_kir_ms_ptr", "S/cm2",
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "cvodeieq");
 	...
 	ivoc_help("help ?1 kir_ms_ptr /home/jofrony/Documents/Repositories/BasalGangliaExperiments/Neuromodulation-software/examples/x86_64/kir_ms_ptr.mod\n");
 ...
 v=_v;
{
  ek = _ion_ek;
 { error =  states();
 if(error){fprintf(stderr,"at line 71 in file kir_ms_ptr.mod:\n    SOLVE states METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/jofrony/Documents/Repositories/BasalGangliaExperiments/Neuromodulation-software/examples/mechanisms-modulation-ptr/kir_ms_ptr.mod";
static const char* nmodl_file_text = 
