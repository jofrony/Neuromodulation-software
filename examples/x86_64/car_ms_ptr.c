...
#define nrn_init _nrn_init__car_ms_ptr
#define _nrn_initial _nrn_initial__car_ms_ptr
#define nrn_cur _nrn_cur__car_ms_ptr
#define _nrn_current _nrn_current__car_ms_ptr
#define nrn_jacob _nrn_jacob__car_ms_ptr
#define nrn_state _nrn_state__car_ms_ptr
#define _net_receive _net_receive__car_ms_ptr 
#define rates rates__car_ms_ptr 
#define states states__car_ms_ptr 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_car_ms_ptr", _hoc_setdata,
 "efun_car_ms_ptr", _hoc_efun,
 "ghk_car_ms_ptr", _hoc_ghk,
 "modulationDA_car_ms_ptr", _hoc_modulationDA,
 "rates_car_ms_ptr", _hoc_rates,
 0, 0
};
#define efun efun_car_ms_ptr
#define ghk ghk_car_ms_ptr
#define modulationDA modulationDA_car_ms_ptr
 extern double efun( double );
 extern double ghk( double , double , double );
 extern double modulationDA( );
 /* declare global and static user variables */
#define q q_car_ms_ptr
 double q = 3;
 ...
 "pbar_car_ms_ptr", "cm/s",
 "ica_car_ms_ptr", "mA/cm2",
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "cvodeieq");
 	...
 	ivoc_help("help ?1 car_ms_ptr /home/jofrony/Documents/Repositories/BasalGangliaExperiments/Neuromodulation-software/examples/x86_64/car_ms_ptr.mod\n");
 ...
 v=_v;
{
  ...
  cao = _ion_cao;
 { error =  states();
 if(error){fprintf(stderr,"at line 75 in file car_ms_ptr.mod:\n    SOLVE states METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/jofrony/Documents/Repositories/BasalGangliaExperiments/Neuromodulation-software/examples/mechanisms-modulation-ptr/car_ms_ptr.mod";
static const char* nmodl_file_text = 
