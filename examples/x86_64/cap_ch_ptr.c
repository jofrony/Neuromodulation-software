...
#define nrn_init _nrn_init__cap_ch_ptr
#define _nrn_initial _nrn_initial__cap_ch_ptr
#define nrn_cur _nrn_cur__cap_ch_ptr
#define _nrn_current _nrn_current__cap_ch_ptr
#define nrn_jacob _nrn_jacob__cap_ch_ptr
#define nrn_state _nrn_state__cap_ch_ptr
#define _net_receive _net_receive__cap_ch_ptr 
#define rates rates__cap_ch_ptr 
#define states states__cap_ch_ptr 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_cap_ch_ptr", _hoc_setdata,
 "ghk_cap_ch_ptr", _hoc_ghk,
 "mtau_func_cap_ch_ptr", _hoc_mtau_func,
 "modulationACh_cap_ch_ptr", _hoc_modulationACh,
 "modulationDA_cap_ch_ptr", _hoc_modulationDA,
 "rates_cap_ch_ptr", _hoc_rates,
 0, 0
};
#define ghk ghk_cap_ch_ptr
#define mtau_func mtau_func_cap_ch_ptr
#define modulationACh modulationACh_cap_ch_ptr
#define modulationDA modulationDA_cap_ch_ptr
...
#define monovalPerm monovalPerm_cap_ch_ptr
 double monovalPerm = 0;
#define monovalConc monovalConc_cap_ch_ptr
 double monovalConc = 140;
#define mtau mtau_cap_ch_ptr
 double mtau = 0;
#define minf minf_cap_ch_ptr
 double minf = 0;
 ...
 "monovalConc_cap_ch_ptr", "mM",
 "mtau_cap_ch_ptr", "ms",
 "gbar_cap_ch_ptr", "cm/s",
 "ica_cap_ch_ptr", "mA/cm2",
 "g_cap_ch_ptr", "S/cm2",
 0,0
};
 ...
 "monovalConc_cap_ch_ptr", &monovalConc_cap_ch_ptr,
 "monovalPerm_cap_ch_ptr", &monovalPerm_cap_ch_ptr,
 "minf_cap_ch_ptr", &minf_cap_ch_ptr,
 "mtau_cap_ch_ptr", &mtau_cap_ch_ptr,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 6, "cvodeieq");
 	...
 	ivoc_help("help ?1 cap_ch_ptr /home/jofrony/Documents/Repositories/BasalGangliaExperiments/Neuromodulation-software/examples/x86_64/cap_ch_ptr.mod\n");
 ...
 v=_v;
{
  ...
  cao = _ion_cao;
 { error =  states();
 if(error){fprintf(stderr,"at line 93 in file cap_ch_ptr.mod:\n     SOLVE states METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/jofrony/Documents/Repositories/BasalGangliaExperiments/Neuromodulation-software/examples/mechanisms-modulation-ptr/cap_ch_ptr.mod";
static const char* nmodl_file_text = 
