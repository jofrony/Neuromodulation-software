...
#define nrn_init _nrn_init__tmGlut_M1RH_D1_ptr
#define _nrn_initial _nrn_initial__tmGlut_M1RH_D1_ptr
#define nrn_cur _nrn_cur__tmGlut_M1RH_D1_ptr
#define _nrn_current _nrn_current__tmGlut_M1RH_D1_ptr
#define nrn_jacob _nrn_jacob__tmGlut_M1RH_D1_ptr
#define nrn_state _nrn_state__tmGlut_M1RH_D1_ptr
#define _net_receive _net_receive__tmGlut_M1RH_D1_ptr 
#define state state__tmGlut_M1RH_D1_ptr 
...
#define maxModACh_AMPA _p[16]
#define modDA _p[17]
#define maxModDA_NMDA _p[18]
#define modACh _p[19]
#define maxModACh_NMDA _p[20]
#define failRateA _p[21]
#define failRateB _p[22]
#define use_stp _p[23]
#define i _p[24]
#define i_ampa _p[25]
#define i_nmda _p[26]
#define g _p[27]
...
#define DC_ampa _p[44]
#define DA_nmda _p[45]
#define DB_nmda _p[46]
#define DC_nmda _p[47]
#define v _p[48]
#define _g _p[49]
#define _tsav _p[50]
...
#define modulationACh_AMPA modulationACh_AMPA_tmGlut_M1RH_D1_ptr
#define modulationDA_AMPA modulationDA_AMPA_tmGlut_M1RH_D1_ptr
#define modulationACh_NMDA modulationACh_NMDA_tmGlut_M1RH_D1_ptr
#define modulationDA_NMDA modulationDA_NMDA_tmGlut_M1RH_D1_ptr
#define urand urand_tmGlut_M1RH_D1_ptr
...
#define tau3_nmda tau3_nmda_tmGlut_M1RH_D1_ptr
 double tau3_nmda = 212.116;
#define tau3_ampa tau3_ampa_tmGlut_M1RH_D1_ptr
 ...
 "tau3_ampa_tmGlut_M1RH_D1_ptr", "ms",
 "tau3_nmda_tmGlut_M1RH_D1_ptr", "ms",
 "tau1_ampa", "ms",
 "tau2_ampa", "ms",
 "tau1_nmda", "ms",
 "tau2_nmda", "ms",
 ...
 "tau3_ampa_tmGlut_M1RH_D1_ptr", &tau3_ampa_tmGlut_M1RH_D1_ptr,
 "tau3_nmda_tmGlut_M1RH_D1_ptr", &tau3_nmda_tmGlut_M1RH_D1_ptr,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
...
#endif
  hoc_register_prop_size(_mechtype, 51, 7);
 ...
 pnt_receive_size[_mechtype] = 5;
 	...
 	ivoc_help("help ?1 tmGlut_M1RH_D1_ptr /home/jofrony/Documents/Repositories/BasalGangliaExperiments/Neuromodulation-software/examples/x86_64/tmglut_M1RH_D1_ptr.mod\n");
...
/*VERBATIM*/
   ...
   if ( urand ( _threadargs_ ) > failRate * ( failRateA * modDA * levelDA + failRateB * modACh * levelACh ) ) {
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/jofrony/Documents/Repositories/BasalGangliaExperiments/Neuromodulation-software/examples/mechanisms-modulation-ptr/tmglut_M1RH_D1_ptr.mod";
static const char* nmodl_file_text = 
