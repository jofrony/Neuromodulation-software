...
#define nrn_init _nrn_init__tmGlut_p
#define _nrn_initial _nrn_initial__tmGlut_p
#define nrn_cur _nrn_cur__tmGlut_p
#define _nrn_current _nrn_current__tmGlut_p
#define nrn_jacob _nrn_jacob__tmGlut_p
#define nrn_state _nrn_state__tmGlut_p
#define _net_receive _net_receive__tmGlut_p 
#define state state__tmGlut_p 
...
#define maxModA_NMDA _p[18]
#define maxModB_NMDA _p[19]
#define failRateA _p[20]
#define use_stp _p[21]
#define failRate _p[22]
#define i _p[23]
#define i_ampa _p[24]
#define i_nmda _p[25]
#define g _p[26]
...
#define B_nmda _p[32]
#define ical _p[33]
#define ical_ampa _p[34]
#define ical_nmda _p[35]
#define factor_ampa _p[36]
#define factor_nmda _p[37]
#define x _p[38]
#define DA_ampa _p[39]
#define DB_ampa _p[40]
...
#define modulationB_AMPA modulationB_AMPA_tmGlut_p
#define modulationA_AMPA modulationA_AMPA_tmGlut_p
#define modulationB_NMDA modulationB_NMDA_tmGlut_p
#define modulationA_NMDA modulationA_NMDA_tmGlut_p
#define urand urand_tmGlut_p
...
extern void _cvode_abstol( Symbol**, double*, int);
...
#endif
  hoc_register_prop_size(_mechtype, 46, 7);
 ...
 pnt_receive_size[_mechtype] = 5;
 	...
 	ivoc_help("help ?1 tmGlut_p /home/jofrony/Documents/Repositories/BasalGangliaExperiments/Neuromodulation-software/local/adaptive/Experiment-Simulation/x86_64/tmglut_p.mod\n");
...
/*VERBATIM*/
   ...
   if ( urand ( _threadargs_ ) < ( failRate * ( 1.0 - failRateA ) ) ) {
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/jofrony/Documents/Repositories/BasalGangliaExperiments/Neuromodulation-software/local/adaptive/Experiment-Simulation/mechanisms-ptr/tmglut_p.mod";
static const char* nmodl_file_text = 
  ...
  "    RANGE failRate, failRateA\n"
  "    RANGE modA, maxModA_AMPA, maxModB_AMPA\n"
