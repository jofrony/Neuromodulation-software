...
#define nrn_init _nrn_init__hcn12_ch_p
#define _nrn_initial _nrn_initial__hcn12_ch_p
#define nrn_cur _nrn_cur__hcn12_ch_p
#define _nrn_current _nrn_current__hcn12_ch_p
#define nrn_jacob _nrn_jacob__hcn12_ch_p
#define nrn_state _nrn_state__hcn12_ch_p
#define _net_receive _net_receive__hcn12_ch_p 
#define kin kin__hcn12_ch_p 
#define rates rates__hcn12_ch_p 
...
#define Dcao _p[17]
#define _g _p[18]
#define levelA	*_ppvar[0]._pval
#define _p_levelA	_ppvar[0]._pval
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_hcn12_ch_p", _hoc_setdata,
 "modulationA_hcn12_ch_p", _hoc_modulationA,
 "rates_hcn12_ch_p", _hoc_rates,
 0, 0
};
#define modulationA modulationA_hcn12_ch_p
 extern double modulationA( );
 /* declare global and static user variables */
#define ai ai_hcn12_ch_p
 double ai = 1e-05;
#define aac aac_hcn12_ch_p
 double aac = -0.075;
#define aah aah_hcn12_ch_p
 double aah = -94.2;
#define aa0 aa0_hcn12_ch_p
 double aa0 = 0.0006;
#define ac ac_hcn12_ch_p
 double ac = -0.155;
#define ah ah_hcn12_ch_p
 double ah = -96;
#define a0 a0_hcn12_ch_p
 double a0 = 0.006;
#define bf bf_hcn12_ch_p
 double bf = 8.94;
#define b b_hcn12_ch_p
 double b = 80;
#define bac bac_hcn12_ch_p
 double bac = 0.144;
#define bah bah_hcn12_ch_p
 double bah = -35.5;
#define ba0 ba0_hcn12_ch_p
 double ba0 = 0.004;
#define bc bc_hcn12_ch_p
 double bc = 0.144;
#define bh bh_hcn12_ch_p
 double bh = -51.7;
#define b0 b0_hcn12_ch_p
 double b0 = 0.0008;
#define gca gca_hcn12_ch_p
 double gca = 1;
#define koff koff_hcn12_ch_p
 double koff = 4.5e-05;
#define kon kon_hcn12_ch_p
 double kon = 30;
#define q10a q10a_hcn12_ch_p
 double q10a = 1.5;
#define q10v q10v_hcn12_ch_p
 double q10v = 4;
#define shift shift_hcn12_ch_p
 double shift = -17;
 ...
 "aac_hcn12_ch_p", "/mV",
 "bac_hcn12_ch_p", "/mV",
 "kon_hcn12_ch_p", "/mM-ms",
 "koff_hcn12_ch_p", "/ms",
 "ai_hcn12_ch_p", "mM",
 "shift_hcn12_ch_p", "mV",
 "gbar_hcn12_ch_p", "S/cm2",
 "ehcn_hcn12_ch_p", "mV",
 "g_hcn12_ch_p", "S/cm2",
 "i_hcn12_ch_p", "mA/cm2",
 0,0
 ...
 "a0_hcn12_ch_p", &a0_hcn12_ch_p,
 "b0_hcn12_ch_p", &b0_hcn12_ch_p,
 "ah_hcn12_ch_p", &ah_hcn12_ch_p,
 "bh_hcn12_ch_p", &bh_hcn12_ch_p,
 "ac_hcn12_ch_p", &ac_hcn12_ch_p,
 "bc_hcn12_ch_p", &bc_hcn12_ch_p,
 "aa0_hcn12_ch_p", &aa0_hcn12_ch_p,
 "ba0_hcn12_ch_p", &ba0_hcn12_ch_p,
 "aah_hcn12_ch_p", &aah_hcn12_ch_p,
 "bah_hcn12_ch_p", &bah_hcn12_ch_p,
 "aac_hcn12_ch_p", &aac_hcn12_ch_p,
 "bac_hcn12_ch_p", &bac_hcn12_ch_p,
 "kon_hcn12_ch_p", &kon_hcn12_ch_p,
 "koff_hcn12_ch_p", &koff_hcn12_ch_p,
 "b_hcn12_ch_p", &b_hcn12_ch_p,
 "bf_hcn12_ch_p", &bf_hcn12_ch_p,
 "ai_hcn12_ch_p", &ai_hcn12_ch_p,
 "gca_hcn12_ch_p", &gca_hcn12_ch_p,
 "shift_hcn12_ch_p", &shift_hcn12_ch_p,
 "q10v_hcn12_ch_p", &q10v_hcn12_ch_p,
 "q10a_hcn12_ch_p", &q10a_hcn12_ch_p,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 1, "cvodeieq");
 	...
 	ivoc_help("help ?1 hcn12_ch_p /home/jofrony/Documents/Repositories/BasalGangliaExperiments/Neuromodulation-software/local/adaptive/Experiment-Simulation/x86_64/hcn12_ch_p.mod\n");
 ...
 t = 0.0;
{
 ...
 if(error){fprintf(stderr,"at line 98 in file hcn12_ch_p.mod:\n	SOLVE kin STEADYSTATE sparse\n"); nrn_complain(_p); abort_run(error);}
    if (secondorder) {
    int _i;
    for (_i = 0; _i < 4; ++_i) {
...
static double _nrn_current(double _v){double _current=0.;v=_v;{ {
   g = gbar * ( o + cao * gca ) * modulationA ( _threadargs_ ) ;
   i = g * ( v - ehcn ) ;
   }
 _current += i;
 ...
 v=_v;
{
 ...
 if(error){fprintf(stderr,"at line 102 in file hcn12_ch_p.mod:\n	SOLVE kin METHOD sparse\n"); nrn_complain(_p); abort_run(error);}
    if (secondorder) {
    int _i;
    for (_i = 0; _i < 4; ++_i) {
      _p[_slist1[_i]] += dt*_p[_dlist1[_i]];
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/jofrony/Documents/Repositories/BasalGangliaExperiments/Neuromodulation-software/local/adaptive/Experiment-Simulation/mechanisms-ptr/hcn12_ch_p.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
  "\n"
