...
#define nrn_init _nrn_init__im_lts_p
#define _nrn_initial _nrn_initial__im_lts_p
#define nrn_cur _nrn_cur__im_lts_p
#define _nrn_current _nrn_current__im_lts_p
#define nrn_jacob _nrn_jacob__im_lts_p
#define nrn_state _nrn_state__im_lts_p
#define _net_receive _net_receive__im_lts_p 
#define evaluate_fct evaluate_fct__im_lts_p 
#define states states__im_lts_p 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_im_lts_p", _hoc_setdata,
 "exptable_im_lts_p", _hoc_exptable,
 "evaluate_fct_im_lts_p", _hoc_evaluate_fct,
 "modulationB_im_lts_p", _hoc_modulationB,
 "modulationA_im_lts_p", _hoc_modulationA,
 0, 0
};
#define _f_exptable _f_exptable_im_lts_p
#define exptable exptable_im_lts_p
#define modulationB modulationB_im_lts_p
#define modulationA modulationA_im_lts_p
 extern double _f_exptable( double );
 extern double exptable( double );
 extern double modulationB( );
 extern double modulationA( );
 /* declare global and static user variables */
#define taumax taumax_im_lts_p
 double taumax = 1000;
#define usetable usetable_im_lts_p
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "usetable_im_lts_p", 0, 1,
 0,0,0
};
 static HocParmUnits _hoc_parm_units[] = {
 "taumax_im_lts_p", "ms",
 "gkbar_im_lts_p", "mho/cm2",
 "ik_im_lts_p", "mA/cm2",
 "tau_m_im_lts_p", "ms",
 0,0
};
 ...
 "taumax_im_lts_p", &taumax_im_lts_p,
 "usetable_im_lts_p", &usetable_im_lts_p,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "cvodeieq");
 	...
 	ivoc_help("help ?1 im_lts_p /home/jofrony/Documents/Repositories/BasalGangliaExperiments/Neuromodulation-software/local/adaptive/Experiment-Simulation/x86_64/im_lts_p.mod\n");
...
static double _nrn_current(double _v){double _current=0.;v=_v;{ {
   ik = gkbar * m * ( v - ek ) * modulationA ( _threadargs_ ) * modulationB ( _threadargs_ ) ;
   }
 _current += ik;
 ...
 v=_v;
{
  ek = _ion_ek;
 { error =  states();
 if(error){fprintf(stderr,"at line 96 in file im_lts_p.mod:\n	SOLVE states METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/jofrony/Documents/Repositories/BasalGangliaExperiments/Neuromodulation-software/local/adaptive/Experiment-Simulation/mechanisms-ptr/im_lts_p.mod";
static const char* nmodl_file_text = 
