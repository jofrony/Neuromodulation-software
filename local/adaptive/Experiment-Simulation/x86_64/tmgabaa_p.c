...
#define nrn_init _nrn_init__tmGabaA_p
#define _nrn_initial _nrn_initial__tmGabaA_p
#define nrn_cur _nrn_cur__tmGabaA_p
#define _nrn_current _nrn_current__tmGabaA_p
#define nrn_jacob _nrn_jacob__tmGabaA_p
#define nrn_state _nrn_state__tmGabaA_p
#define _net_receive _net_receive__tmGabaA_p 
#define state state__tmGabaA_p 
...
#define failRateA _p[9]
#define modA _p[10]
#define maxModA _p[11]
#define modB _p[12]
#define maxModB _p[13]
#define failRateB _p[14]
#define i _p[15]
#define A _p[16]
#define B _p[17]
#define g _p[18]
...
#define levelA	*_ppvar[2]._pval
#define _p_levelA	_ppvar[2]._pval
...
#define modulationB modulationB_tmGabaA_p
#define modulationA modulationA_tmGabaA_p
#define urand urand_tmGabaA_p
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 5;
 	...
 	ivoc_help("help ?1 tmGabaA_p /home/jofrony/Documents/Repositories/BasalGangliaExperiments/Neuromodulation-software/local/adaptive/Experiment-Simulation/x86_64/tmgabaa_p.mod\n");
...
/*VERBATIM*/
   ...
   if ( urand ( _threadargs_ ) > ( failRate + failRateA * levelA * failRateB * levelB ) ) {
...
{
 { error =  state();
 if(error){fprintf(stderr,"at line 92 in file tmgabaa_p.mod:\n    SOLVE state METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 }}}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/jofrony/Documents/Repositories/BasalGangliaExperiments/Neuromodulation-software/local/adaptive/Experiment-Simulation/mechanisms-ptr/tmgabaa_p.mod";
static const char* nmodl_file_text = 
