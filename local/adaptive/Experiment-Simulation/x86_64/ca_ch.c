...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 6, "area");
 	...
 	ivoc_help("help ?1 ca_ch /home/jofrony/Documents/Repositories/BasalGangliaExperiments/Neuromodulation/striatal_network/synapse-wide/Experiment-Simulation/x86_64/ca_ch.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/jofrony/Documents/Repositories/BasalGangliaData/mod-ptr-files/ca_ch.mod";
static const char* nmodl_file_text = 
