...
#define nrn_init _nrn_init__kir_ms_p
#define _nrn_initial _nrn_initial__kir_ms_p
#define nrn_cur _nrn_cur__kir_ms_p
#define _nrn_current _nrn_current__kir_ms_p
#define nrn_jacob _nrn_jacob__kir_ms_p
#define nrn_state _nrn_state__kir_ms_p
#define _net_receive _net_receive__kir_ms_p 
#define rates rates__kir_ms_p 
#define states states__kir_ms_p 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_kir_ms_p", _hoc_setdata,
 "modulationB_kir_ms_p", _hoc_modulationB,
 "modulationA_kir_ms_p", _hoc_modulationA,
 "rates_kir_ms_p", _hoc_rates,
 0, 0
};
#define modulationB modulationB_kir_ms_p
#define modulationA modulationA_kir_ms_p
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "cvodeieq");
 	...
 	ivoc_help("help ?1 kir_ms_p /home/jofrony/Documents/Repositories/BasalGangliaExperiments/Neuromodulation-software/local/adaptive/Experiment-Simulation/x86_64/kir_ms_p.mod\n");
 ...
 v=_v;
{
  ek = _ion_ek;
 { error =  states();
 if(error){fprintf(stderr,"at line 70 in file kir_ms_p.mod:\n    SOLVE states METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/jofrony/Documents/Repositories/BasalGangliaExperiments/Neuromodulation-software/local/adaptive/Experiment-Simulation/mechanisms-ptr/kir_ms_p.mod";
static const char* nmodl_file_text = 
