...
#define nrn_init _nrn_init__M4p
#define _nrn_initial _nrn_initial__M4p
#define nrn_cur _nrn_cur__M4p
#define _nrn_current _nrn_current__M4p
#define nrn_jacob _nrn_jacob__M4p
#define nrn_state _nrn_state__M4p
#define _net_receive _net_receive__M4p 
#define kin kin__M4p 
...
#define Ach_M4R _p[5]
#define Giabg _p[6]
#define Giabg_M4R _p[7]
#define Ach_M4R_Giabg _p[8]
#define GiaGTP _p[9]
#define GiaGDP _p[10]
#define Gbg _p[11]
#define A _p[12]
...
#define DAch _p[14]
#define DM4R _p[15]
#define DAch_M4R _p[16]
#define DGiabg _p[17]
#define DGiabg_M4R _p[18]
#define DAch_M4R_Giabg _p[19]
#define DGiaGTP _p[20]
#define DGiaGDP _p[21]
#define DGbg _p[22]
#define DA _p[23]
#define DB _p[24]
#define i _p[25]
...
#define conc_acetylcholine	*_ppvar[2]._pval
#define _p_conc_acetylcholine	_ppvar[2]._pval
...
#define Total_Gi Total_Gi_M4p
#define acetylcholine acetylcholine_M4p
#define total_M4R total_M4R_M4p
...
#define e e_M4p
 double e = 0;
#define init_Gbg init_Gbg_M4p
 double init_Gbg = 120;
#define init_GiaGDP init_GiaGDP_M4p
 double init_GiaGDP = 0;
#define init_GiaGTP init_GiaGTP_M4p
 double init_GiaGTP = 80;
#define init_Ach_M4R_Giabg init_Ach_M4R_Giabg_M4p
 double init_Ach_M4R_Giabg = 0;
#define init_Giabg_M4R init_Giabg_M4R_M4p
 double init_Giabg_M4R = 80;
#define init_Giabg init_Giabg_M4p
 double init_Giabg = 1680;
#define init_Ach_M4R init_Ach_M4R_M4p
 double init_Ach_M4R = 0;
#define init_M4R init_M4R_M4p
 double init_M4R = 120;
#define init_Ach init_Ach_M4p
 double init_Ach = 105;
#define init_AChE init_AChE_M4p
 double init_AChE = 1;
#define kb_GiaGDP kb_GiaGDP_M4p
 double kb_GiaGDP = 0;
#define kf_GiaGDP kf_GiaGDP_M4p
 double kf_GiaGDP = 2;
#define kb_GiaGTP kb_GiaGTP_M4p
 double kb_GiaGTP = 0;
#define kf_GiaGTP kf_GiaGTP_M4p
 double kf_GiaGTP = 4;
#define kb_Ach_M4R_Gi kb_Ach_M4R_Gi_M4p
 double kb_Ach_M4R_Gi = 0;
#define kf_Ach_M4R_Gi kf_Ach_M4R_Gi_M4p
 double kf_Ach_M4R_Gi = 8;
#define kb_AchM4RxGiabg kb_AchM4RxGiabg_M4p
 double kb_AchM4RxGiabg = 3.36;
#define kf_AchM4RxGiabg kf_AchM4RxGiabg_M4p
 double kf_AchM4RxGiabg = 0.192;
#define kb_M4RxGiabg kb_M4RxGiabg_M4p
 double kb_M4RxGiabg = 0.42;
#define kf_M4RxGiabg kf_M4RxGiabg_M4p
 double kf_M4RxGiabg = 0.00178;
#define kbAchxM4R_Gi kbAchxM4R_Gi_M4p
 double kbAchxM4R_Gi = 20;
#define kf_AchxM4R_Gi kf_AchxM4R_Gi_M4p
 double kf_AchxM4R_Gi = 0.036;
#define kb_AchxM4R kb_AchxM4R_M4p
 double kb_AchxM4R = 2.5;
#define kf_AchxM4R kf_AchxM4R_M4p
 double kf_AchxM4R = 0.000338;
#define one_s_rs one_s_rs_M4p
 double one_s_rs = 0.001;
#define two_s_rs two_s_rs_M4p
 ...
 "kf_AchxM4R_M4p", &kf_AchxM4R_M4p,
 "kb_AchxM4R_M4p", &kb_AchxM4R_M4p,
 "kf_AchxM4R_Gi_M4p", &kf_AchxM4R_Gi_M4p,
 "kbAchxM4R_Gi_M4p", &kbAchxM4R_Gi_M4p,
 "kf_M4RxGiabg_M4p", &kf_M4RxGiabg_M4p,
 "kb_M4RxGiabg_M4p", &kb_M4RxGiabg_M4p,
 "kf_AchM4RxGiabg_M4p", &kf_AchM4RxGiabg_M4p,
 "kb_AchM4RxGiabg_M4p", &kb_AchM4RxGiabg_M4p,
 "kf_Ach_M4R_Gi_M4p", &kf_Ach_M4R_Gi_M4p,
 "kb_Ach_M4R_Gi_M4p", &kb_Ach_M4R_Gi_M4p,
 "kf_GiaGTP_M4p", &kf_GiaGTP_M4p,
 "kb_GiaGTP_M4p", &kb_GiaGTP_M4p,
 "kf_GiaGDP_M4p", &kf_GiaGDP_M4p,
 "kb_GiaGDP_M4p", &kb_GiaGDP_M4p,
 "init_AChE_M4p", &init_AChE_M4p,
 "init_Ach_M4p", &init_Ach_M4p,
 "init_M4R_M4p", &init_M4R_M4p,
 "init_Ach_M4R_M4p", &init_Ach_M4R_M4p,
 "init_Giabg_M4p", &init_Giabg_M4p,
 "init_Giabg_M4R_M4p", &init_Giabg_M4R_M4p,
 "init_Ach_M4R_Giabg_M4p", &init_Ach_M4R_Giabg_M4p,
 "init_GiaGTP_M4p", &init_GiaGTP_M4p,
 "init_GiaGDP_M4p", &init_GiaGDP_M4p,
 "init_Gbg_M4p", &init_Gbg_M4p,
 "cc_M4p", &cc_M4p,
 "two_s_rs_M4p", &two_s_rs_M4p,
 "one_s_rs_M4p", &one_s_rs_M4p,
 "e_M4p", &e_M4p,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 M4p /home/jofrony/Documents/Repositories/BasalGangliaExperiments/Neuromodulation-software/local/adaptive/Experiment-Simulation/x86_64/M4p.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/jofrony/Documents/Repositories/BasalGangliaExperiments/Neuromodulation-software/local/adaptive/Experiment-Simulation/mechanisms-ptr/M4p.mod";
static const char* nmodl_file_text = 
