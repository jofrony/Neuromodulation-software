...
#define nrn_init _nrn_init__na2_ch_p
#define _nrn_initial _nrn_initial__na2_ch_p
#define nrn_cur _nrn_cur__na2_ch_p
#define _nrn_current _nrn_current__na2_ch_p
#define nrn_jacob _nrn_jacob__na2_ch_p
#define nrn_state _nrn_state__na2_ch_p
#define _net_receive _net_receive__na2_ch_p 
#define kin kin__na2_ch_p 
#define rates rates__na2_ch_p 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_na2_ch_p", _hoc_setdata,
 "modulationA_na2_ch_p", _hoc_modulationA,
 "rates_na2_ch_p", _hoc_rates,
 0, 0
};
#define modulationA modulationA_na2_ch_p
 extern double modulationA( );
 /* declare global and static user variables */
#define Coff Coff_na2_ch_p
 double Coff = 0.1;
#define Con Con_na2_ch_p
 double Con = 0.001;
#define Ooff Ooff_na2_ch_p
 double Ooff = 0.01;
#define Oon Oon_na2_ch_p
 double Oon = 1.6;
#define aS2 aS2_na2_ch_p
 double aS2 = 0.0002;
#define aS1 aS1_na2_ch_p
 double aS1 = 0.0025;
#define a0 a0_na2_ch_p
 double a0 = 37;
#define bS bS_na2_ch_p
 double bS = 0.00017;
#define b0 b0_na2_ch_p
 double b0 = 10;
#define d0 d0_na2_ch_p
 double d0 = 30;
#define g0 g0_na2_ch_p
 double g0 = 40;
#define vcb vcb_na2_ch_p
 double vcb = -10;
#define vhb vhb_na2_ch_p
 double vhb = -50;
#define vca vca_na2_ch_p
 double vca = 40;
#define vha vha_na2_ch_p
 double vha = 45;
 ...
 "a0_na2_ch_p", &a0_na2_ch_p,
 "vha_na2_ch_p", &vha_na2_ch_p,
 "vca_na2_ch_p", &vca_na2_ch_p,
 "b0_na2_ch_p", &b0_na2_ch_p,
 "vhb_na2_ch_p", &vhb_na2_ch_p,
 "vcb_na2_ch_p", &vcb_na2_ch_p,
 "g0_na2_ch_p", &g0_na2_ch_p,
 "d0_na2_ch_p", &d0_na2_ch_p,
 "aS1_na2_ch_p", &aS1_na2_ch_p,
 "aS2_na2_ch_p", &aS2_na2_ch_p,
 "bS_na2_ch_p", &bS_na2_ch_p,
 "Con_na2_ch_p", &Con_na2_ch_p,
 "Coff_na2_ch_p", &Coff_na2_ch_p,
 "Oon_na2_ch_p", &Oon_na2_ch_p,
 "Ooff_na2_ch_p", &Ooff_na2_ch_p,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 na2_ch_p /home/jofrony/Documents/Repositories/BasalGangliaExperiments/Neuromodulation-software/local/adaptive/Experiment-Simulation/x86_64/na2_ch_p.mod\n");
 ...
 t = 0.0;
{
 ...
 if(error){fprintf(stderr,"at line 132 in file na2_ch_p.mod:\n	SOLVE kin STEADYSTATE sparse\n"); nrn_complain(_p); abort_run(error);}
    if (secondorder) {
    int _i;
    for (_i = 0; _i < 14; ++_i) {
 ...
 v=_v;
{
 ...
 if(error){fprintf(stderr,"at line 122 in file na2_ch_p.mod:\n	SOLVE kin METHOD sparse\n"); nrn_complain(_p); abort_run(error);}
    if (secondorder) {
    int _i;
    for (_i = 0; _i < 14; ++_i) {
      _p[_slist1[_i]] += dt*_p[_dlist1[_i]];
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/jofrony/Documents/Repositories/BasalGangliaExperiments/Neuromodulation-software/local/adaptive/Experiment-Simulation/mechanisms-ptr/na2_ch_p.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
  "NA2_CH.MOD\n"
  "\n"
