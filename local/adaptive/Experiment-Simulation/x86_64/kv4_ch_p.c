...
#define nrn_init _nrn_init__kv4_ch_p
#define _nrn_initial _nrn_initial__kv4_ch_p
#define nrn_cur _nrn_cur__kv4_ch_p
#define _nrn_current _nrn_current__kv4_ch_p
#define nrn_jacob _nrn_jacob__kv4_ch_p
#define nrn_state _nrn_state__kv4_ch_p
#define _net_receive _net_receive__kv4_ch_p 
#define kin kin__kv4_ch_p 
#define rates rates__kv4_ch_p 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_kv4_ch_p", _hoc_setdata,
 "modulationA_kv4_ch_p", _hoc_modulationA,
 "rates_kv4_ch_p", _hoc_rates,
 0, 0
};
#define modulationA modulationA_kv4_ch_p
 extern double modulationA( );
 /* declare global and static user variables */
#define am am_kv4_ch_p
 double am = 1;
#define a a_kv4_ch_p
 double a = 3;
#define alpha alpha_kv4_ch_p
 double alpha = 0;
#define bm bm_kv4_ch_p
 double bm = 7;
#define b b_kv4_ch_p
 double b = 40;
#define beta beta_kv4_ch_p
 double beta = 0;
#define ci ci_kv4_ch_p
 double ci = 0.2;
#define delta delta_kv4_ch_p
 double delta = 4;
#define gamma gamma_kv4_ch_p
 double gamma = 200;
#define isi5 isi5_kv4_ch_p
 double isi5 = 0.001;
#define i5is i5is_kv4_ch_p
 double i5is = 0.001;
#define io io_kv4_ch_p
 double io = 0.01;
#define ic ic_kv4_ch_p
 double ic = 500;
#define oi oi_kv4_ch_p
 double oi = 1e-09;
#define q10v q10v_kv4_ch_p
 double q10v = 3;
#define q10i q10i_kv4_ch_p
 double q10i = 3;
#define vhb vhb_kv4_ch_p
 double vhb = -30;
#define vha vha_kv4_ch_p
 double vha = -75;
#define vc vc_kv4_ch_p
 double vc = 10;
 ...
 "gamma_kv4_ch_p", &gamma_kv4_ch_p,
 "delta_kv4_ch_p", &delta_kv4_ch_p,
 "a_kv4_ch_p", &a_kv4_ch_p,
 "b_kv4_ch_p", &b_kv4_ch_p,
 "ic_kv4_ch_p", &ic_kv4_ch_p,
 "oi_kv4_ch_p", &oi_kv4_ch_p,
 "io_kv4_ch_p", &io_kv4_ch_p,
 "ci_kv4_ch_p", &ci_kv4_ch_p,
 "am_kv4_ch_p", &am_kv4_ch_p,
 "bm_kv4_ch_p", &bm_kv4_ch_p,
 "vc_kv4_ch_p", &vc_kv4_ch_p,
 "vha_kv4_ch_p", &vha_kv4_ch_p,
 "vhb_kv4_ch_p", &vhb_kv4_ch_p,
 "i5is_kv4_ch_p", &i5is_kv4_ch_p,
 "isi5_kv4_ch_p", &isi5_kv4_ch_p,
 "q10i_kv4_ch_p", &q10i_kv4_ch_p,
 "q10v_kv4_ch_p", &q10v_kv4_ch_p,
 "alpha_kv4_ch_p", &alpha_kv4_ch_p,
 "beta_kv4_ch_p", &beta_kv4_ch_p,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 kv4_ch_p /home/jofrony/Documents/Repositories/BasalGangliaExperiments/Neuromodulation-software/local/adaptive/Experiment-Simulation/x86_64/kv4_ch_p.mod\n");
 ...
 t = 0.0;
{
 ...
 if(error){fprintf(stderr,"at line 108 in file kv4_ch_p.mod:\n	SOLVE kin STEADYSTATE sparse\n"); nrn_complain(_p); abort_run(error);}
    if (secondorder) {
    int _i;
    for (_i = 0; _i < 11; ++_i) {
...
static double _nrn_current(double _v){double _current=0.;v=_v;{ {
   g = gbar * o * modulationA ( _threadargs_ ) ;
   ik = g * ( v - ek ) ;
   }
 _current += ik;
 ...
 v=_v;
{
 ...
 if(error){fprintf(stderr,"at line 102 in file kv4_ch_p.mod:\n	SOLVE kin METHOD sparse\n"); nrn_complain(_p); abort_run(error);}
    if (secondorder) {
    int _i;
    for (_i = 0; _i < 11; ++_i) {
      _p[_slist1[_i]] += dt*_p[_dlist1[_i]];
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/jofrony/Documents/Repositories/BasalGangliaExperiments/Neuromodulation-software/local/adaptive/Experiment-Simulation/mechanisms-ptr/kv4_ch_p.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
  "\n"
  "c1 - c2 - c3 - c4 - o\n"
