...
#define nrn_init _nrn_init__cal12_ms_p
#define _nrn_initial _nrn_initial__cal12_ms_p
#define nrn_cur _nrn_cur__cal12_ms_p
#define _nrn_current _nrn_current__cal12_ms_p
#define nrn_jacob _nrn_jacob__cal12_ms_p
#define nrn_state _nrn_state__cal12_ms_p
#define _net_receive _net_receive__cal12_ms_p 
#define rates rates__cal12_ms_p 
#define states states__cal12_ms_p 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_cal12_ms_p", _hoc_setdata,
 "efun_cal12_ms_p", _hoc_efun,
 "ghk_cal12_ms_p", _hoc_ghk,
 "modulationB_cal12_ms_p", _hoc_modulationB,
 "modulationA_cal12_ms_p", _hoc_modulationA,
 "rates_cal12_ms_p", _hoc_rates,
 0, 0
};
#define efun efun_cal12_ms_p
#define ghk ghk_cal12_ms_p
#define modulationB modulationB_cal12_ms_p
#define modulationA modulationA_cal12_ms_p
...
#define a a_cal12_ms_p
 double a = 0.17;
#define q q_cal12_ms_p
 double q = 2;
 ...
 "pbar_cal12_ms_p", "cm/s",
 "ical_cal12_ms_p", "mA/cm2",
 0,0
};
 ...
 "a_cal12_ms_p", &a_cal12_ms_p,
 "q_cal12_ms_p", &q_cal12_ms_p,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 6, "cvodeieq");
 	...
 	ivoc_help("help ?1 cal12_ms_p /home/jofrony/Documents/Repositories/BasalGangliaExperiments/Neuromodulation-software/local/adaptive/Experiment-Simulation/x86_64/cal12_ms_p.mod\n");
 ...
 v=_v;
{
  ...
  calo = _ion_calo;
 { error =  states();
 if(error){fprintf(stderr,"at line 80 in file cal12_ms_p.mod:\n    SOLVE states METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/jofrony/Documents/Repositories/BasalGangliaExperiments/Neuromodulation-software/local/adaptive/Experiment-Simulation/mechanisms-ptr/cal12_ms_p.mod";
static const char* nmodl_file_text = 
