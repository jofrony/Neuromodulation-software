...
#define nrn_init _nrn_init__naf_lts_p
#define _nrn_initial _nrn_initial__naf_lts_p
#define nrn_cur _nrn_cur__naf_lts_p
#define _nrn_current _nrn_current__naf_lts_p
#define nrn_jacob _nrn_jacob__naf_lts_p
#define nrn_state _nrn_state__naf_lts_p
#define _net_receive _net_receive__naf_lts_p 
#define rates rates__naf_lts_p 
#define states states__naf_lts_p 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_naf_lts_p", _hoc_setdata,
 "modulationA_naf_lts_p", _hoc_modulationA,
 "rates_naf_lts_p", _hoc_rates,
 0, 0
};
#define modulationA modulationA_naf_lts_p
 extern double modulationA( );
 /* declare global and static user variables */
#define q q_naf_lts_p
 double q = 1.8;
 ...
 "gbar_naf_lts_p", "S/cm2",
 "ina_naf_lts_p", "mA/cm2",
 "gna_naf_lts_p", "S/cm2",
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 naf_lts_p /home/jofrony/Documents/Repositories/BasalGangliaExperiments/Neuromodulation-software/local/adaptive/Experiment-Simulation/x86_64/naf_lts_p.mod\n");
...
static double _nrn_current(double _v){double _current=0.;v=_v;{ {
   gna = gbar * m * m * m * h * modulationA ( _threadargs_ ) ;
   ina = gna * ( v - ena ) ;
   }
 _current += ina;
 ...
 v=_v;
{
  ena = _ion_ena;
 { error =  states();
 if(error){fprintf(stderr,"at line 68 in file naf_lts_p.mod:\n    SOLVE states METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/jofrony/Documents/Repositories/BasalGangliaExperiments/Neuromodulation-software/local/adaptive/Experiment-Simulation/mechanisms-ptr/naf_lts_p.mod";
static const char* nmodl_file_text = 
