...
#define nrn_init _nrn_init__car_ms_p
#define _nrn_initial _nrn_initial__car_ms_p
#define nrn_cur _nrn_cur__car_ms_p
#define _nrn_current _nrn_current__car_ms_p
#define nrn_jacob _nrn_jacob__car_ms_p
#define nrn_state _nrn_state__car_ms_p
#define _net_receive _net_receive__car_ms_p 
#define rates rates__car_ms_p 
#define states states__car_ms_p 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_car_ms_p", _hoc_setdata,
 "efun_car_ms_p", _hoc_efun,
 "ghk_car_ms_p", _hoc_ghk,
 "modulationA_car_ms_p", _hoc_modulationA,
 "rates_car_ms_p", _hoc_rates,
 0, 0
};
#define efun efun_car_ms_p
#define ghk ghk_car_ms_p
#define modulationA modulationA_car_ms_p
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "cvodeieq");
 	...
 	ivoc_help("help ?1 car_ms_p /home/jofrony/Documents/Repositories/BasalGangliaExperiments/Neuromodulation-software/local/adaptive/Experiment-Simulation/x86_64/car_ms_p.mod\n");
 ...
 v=_v;
{
  ...
  cao = _ion_cao;
 { error =  states();
 if(error){fprintf(stderr,"at line 75 in file car_ms_p.mod:\n    SOLVE states METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/jofrony/Documents/Repositories/BasalGangliaExperiments/Neuromodulation-software/local/adaptive/Experiment-Simulation/mechanisms-ptr/car_ms_p.mod";
static const char* nmodl_file_text = 
