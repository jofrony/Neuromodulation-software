...
#define nrn_init _nrn_init__cal_ch_p
#define _nrn_initial _nrn_initial__cal_ch_p
#define nrn_cur _nrn_cur__cal_ch_p
#define _nrn_current _nrn_current__cal_ch_p
#define nrn_jacob _nrn_jacob__cal_ch_p
#define nrn_state _nrn_state__cal_ch_p
#define _net_receive _net_receive__cal_ch_p 
#define rate rate__cal_ch_p 
#define state state__cal_ch_p 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_cal_ch_p", _hoc_setdata,
 "KTF_cal_ch_p", _hoc_KTF,
 "alp_cal_ch_p", _hoc_alp,
 "bet_cal_ch_p", _hoc_bet,
 "efun_cal_ch_p", _hoc_efun,
 "ghk_cal_ch_p", _hoc_ghk,
 "h2_cal_ch_p", _hoc_h2,
 "modulationB_cal_ch_p", _hoc_modulationB,
 "rate_cal_ch_p", _hoc_rate,
 0, 0
};
#define KTF KTF_cal_ch_p
#define _f_bet _f_bet_cal_ch_p
#define _f_alp _f_alp_cal_ch_p
#define alp alp_cal_ch_p
#define bet bet_cal_ch_p
#define efun efun_cal_ch_p
#define ghk ghk_cal_ch_p
#define h2 h2_cal_ch_p
#define modulationB modulationB_cal_ch_p
...
#define Ctm Ctm_cal_ch_p
 double Ctm = 3;
#define atm atm_cal_ch_p
 double atm = 12;
#define btm btm_cal_ch_p
 double btm = 11;
#define ki ki_cal_ch_p
 double ki = 0.001;
#define minf minf_cal_ch_p
 double minf = 0;
#define tfa tfa_cal_ch_p
 double tfa = 1;
#define tau tau_cal_ch_p
 double tau = 0;
#define tm0 tm0_cal_ch_p
 double tm0 = 0;
#define usetable usetable_cal_ch_p
 double usetable = 1;
#define vhtm vhtm_cal_ch_p
 double vhtm = -2;
#define vcm vcm_cal_ch_p
 double vcm = 5.6;
#define vhm vhm_cal_ch_p
 double vhm = -1.5;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "usetable_cal_ch_p", 0, 1,
 0,0,0
};
 static HocParmUnits _hoc_parm_units[] = {
 "ki_cal_ch_p", "mM",
 "tau_cal_ch_p", "ms",
 "gbar_cal_ch_p", "mho/cm2",
 "ica_cal_ch_p", "mA/cm2",
 "gcal_cal_ch_p", "mho/cm2",
 0,0
};
 ...
 "ki_cal_ch_p", &ki_cal_ch_p,
 "tfa_cal_ch_p", &tfa_cal_ch_p,
 "vhm_cal_ch_p", &vhm_cal_ch_p,
 "vcm_cal_ch_p", &vcm_cal_ch_p,
 "Ctm_cal_ch_p", &Ctm_cal_ch_p,
 "atm_cal_ch_p", &atm_cal_ch_p,
 "btm_cal_ch_p", &btm_cal_ch_p,
 "tm0_cal_ch_p", &tm0_cal_ch_p,
 "vhtm_cal_ch_p", &vhtm_cal_ch_p,
 "minf_cal_ch_p", &minf_cal_ch_p,
 "tau_cal_ch_p", &tau_cal_ch_p,
 "usetable_cal_ch_p", &usetable_cal_ch_p,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "cvodeieq");
 	...
 	ivoc_help("help ?1 cal_ch_p /home/jofrony/Documents/Repositories/BasalGangliaExperiments/Neuromodulation-software/local/adaptive/Experiment-Simulation/x86_64/cal_ch_p.mod\n");
...
static double _nrn_current(double _v){double _current=0.;v=_v;{ {
   ...
   ica = gcal * ghk ( _threadargscomma_ v , cai , cao ) * modulationB ( _threadargs_ ) ;
   }
 _current += ica;
 ...
 v=_v;
{
  ...
  cao = _ion_cao;
 { error =  state();
 if(error){fprintf(stderr,"at line 57 in file cal_ch_p.mod:\n	SOLVE state METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/jofrony/Documents/Repositories/BasalGangliaExperiments/Neuromodulation-software/local/adaptive/Experiment-Simulation/mechanisms-ptr/cal_ch_p.mod";
static const char* nmodl_file_text = 
  ...
  "	ica  = gcal*ghk(v,cai,cao)*modulationB()\n"
  "}\n"
  "\n"
  "INITIAL {\n"
  "	rate(v)\n"
