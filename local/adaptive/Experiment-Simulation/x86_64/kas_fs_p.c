...
#define nrn_init _nrn_init__kas_fs_p
#define _nrn_initial _nrn_initial__kas_fs_p
#define nrn_cur _nrn_cur__kas_fs_p
#define _nrn_current _nrn_current__kas_fs_p
#define nrn_jacob _nrn_jacob__kas_fs_p
#define nrn_state _nrn_state__kas_fs_p
#define _net_receive _net_receive__kas_fs_p 
#define rates rates__kas_fs_p 
#define states states__kas_fs_p 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_kas_fs_p", _hoc_setdata,
 "modulationA_kas_fs_p", _hoc_modulationA,
 "rates_kas_fs_p", _hoc_rates,
 0, 0
};
#define modulationA modulationA_kas_fs_p
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 kas_fs_p /home/jofrony/Documents/Repositories/BasalGangliaExperiments/Neuromodulation-software/local/adaptive/Experiment-Simulation/x86_64/kas_fs_p.mod\n");
 ...
 v=_v;
{
  ek = _ion_ek;
 { error =  states();
 if(error){fprintf(stderr,"at line 70 in file kas_fs_p.mod:\n    SOLVE states METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/jofrony/Documents/Repositories/BasalGangliaExperiments/Neuromodulation-software/local/adaptive/Experiment-Simulation/mechanisms-ptr/kas_fs_p.mod";
static const char* nmodl_file_text = 
