...
class iSPNanalysis(optimisationResult):
    ...
    def __init__(self,dir_path):
        ...
        super(iSPNanalysis,self).__init__(dir_path=dir_path)
    ...
    def dopamine_analysis(self):
        ...
        for volt in self.voltages[1:-1]:
            ...
            result = sc.number_AP_decrease(criteria,[self.voltages[-1],volt])
    ...
    def save_selected_modulation_dopamine(self):
    ...
    def save_selected_modulation_muscarinic(self):
