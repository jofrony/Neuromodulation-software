...
DOPAMINELEVELONE=$NEUROMODSOFT/supercomputer/Experiment-simulation/Level6/
...
if [ $SLURM_PROCID -gt 0 ]; then
    ...
    python3 $PROJECT_CODE/init_neuromod.py $NEUROMODSOFT/network_parameters/neurons $NEUROMODSOFT/supercomputer/Experiment-simulation/Level6/pdc_network/
    ...
    cp -a $NEUROMODSOFT/network_parameters/external_input/external-input-dSTR-scaled-level6.json ${JOBDIR}/input.json
