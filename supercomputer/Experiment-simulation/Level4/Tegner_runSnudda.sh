...
DOPAMINELEVELONE=$NEUROMODSOFT/supercomputer/Experiment-simulation/Level4/
...
if [ $SLURM_PROCID -gt 0 ]; then
    ...
    python3 $PROJECT_CODE/init_neuromod.py $NEUROMODSOFT/network_parameters/neurons $NEUROMODSOFT/supercomputer/Experiment-simulation/Level4/pdc_network/
