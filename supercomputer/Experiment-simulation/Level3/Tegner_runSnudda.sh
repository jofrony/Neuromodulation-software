...
DOPAMINELEVELONE=$NEUROMODSOFT/supercomputer/Experiment-simulation/Level3/
...
if [ $SLURM_PROCID -gt 0 ]; then
    ...
    python3 $PROJECT_CODE/init_neuromod.py $NEUROMODSOFT/network_parameters/neurons $NEUROMODSOFT/supercomputer/Experiment-simulation/Level3/pdc_network/
    ...
    cp -a $NEUROMODSOFT/network_parameters/external_input/external-input-dSTR-scaled-level3.json ${JOBDIR}/input.json
