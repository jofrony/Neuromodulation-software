...
DOPAMINELEVELONE=$NEUROMODSOFT/supercomputer/Experiment-simulation/Dopamine-Timing/
...
if [ $SLURM_PROCID -gt 0 ]; then
    ...
    python3 $PROJECT_CODE/init_neuromod.py $NEUROMODSOFT/network_parameters/neurons $NEUROMODSOFT/supercomputer/Experiment-simulation/Dopamine-Timing/pdc_network/
    ...
    cp -a $NEUROMODSOFT/network_parameters/external_input/external-input-dSTR-scaled-level4.json ${JOBDIR}/input.json
